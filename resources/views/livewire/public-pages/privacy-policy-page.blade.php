    ...
    <section class="pt-24 pb-6 md:pt-28 md:pb-8 bg-gradient-to-br from-emerald-50 via-white to-purple-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="text-xl md:text-3xl font-black text-gray-900 mb-2">
                Kebijakan <span class="text-gradient">Privasi</span>
            </h1>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 text-sm leading-relaxed pl-11">
                    Fanantara menghargai privasi Anda dan berkomitmen untuk melindungi informasi pribadi yang Anda berikan kepada kami.
                </p>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 text-sm leading-relaxed pl-11 mb-2">
                    Informasi yang kami kumpulkan digunakan untuk:
                </p>
                <div class="pl-11 space-y-2">
                    <div class="flex items-start gap-2">
                        <i class="bi bi-arrow-right-circle-fill text-purple-500 mt-0.5 text-sm"></i>
                        <p class="text-gray-600 text-sm">Memproses pendaftaran keanggotaan</p>
                    </div>
                    <div class="flex items-start gap-2">
                        <i class="bi bi-arrow-right-circle-fill text-purple-500 mt-0.5 text-sm"></i>
                        <p class="text-gray-600 text-sm">Mengelola akun dan transaksi Anda</p>
                    </div>
                    <div class="flex items-start gap-2">
                        <i class="bi bi-arrow-right-circle-fill text-purple-500 mt-0.5 text-sm"></i>
                        <p class="text-gray-600 text-sm">Menghitung dan mendistribusikan SHU</p>
                    </div>
                    <div class="flex items-start gap-2">
                        <i class="bi bi-arrow-right-circle-fill text-purple-500 mt-0.5 text-sm"></i>
                        <p class="text-gray-600 text-sm">Mengirimkan informasi penting terkait koperasi</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 text-sm leading-relaxed pl-11">
                    Kami menerapkan langkah-langkah keamanan teknis dan organisasional untuk melindungi data pribadi Anda dari akses tidak sah, pengungkapan, perubahan, atau penghancuran.
                </p>
            </div>
